...
class ReviewIssue(BaseModel):
    ...
    screenshot_path: Optional[str] = None  # Local file path to screenshot or output file (e.g., "agents/ADW-123/reviewer/review_img/error.png")
